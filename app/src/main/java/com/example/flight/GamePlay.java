...
public class GamePlay implements Screen {
	...
	public void hide() {
        ...
        Log.w("LifeCycle","GamePlayHide");
	}
    
    public void setEnemies(int num) {
    	enemies_.clear();
    //	for (int i = 0 ; i < num; i++) {
            enemy_ = new HeroUnit(game.mgr,"data/Su-27_Flanker.g3db" , "Su-27",true);
      //    		enemies_.add(unit);
    //	}
    }
	...
	@Override
	public void show() {
        Log.w("LifeCycle","GamePlayresumeshow");
	}
	...
	@Override
	public void dispose() {
        Log.w("LifeCycle","GamePlayresumedispose");
		modelBatch.dispose();
		//model.dispose();
	}
	...
	public void resize(int width, int height) {
        Log.w("LifeCycle","GamePlayResize");
	}

	@Override
	public void pause() {
        Log.w("LifeCycle","GamePlayPause");
	}

	@Override
	public void resume() {
        Log.w("LifeCycle","GamePlayResume");
	}
